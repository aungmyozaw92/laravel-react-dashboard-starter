...
import { ArrowLeft, Save, User, Mail, Lock, UserPlus, EditIcon } from 'lucide-react';
...
export default function Edit({ permissions, rolePermissions, role }: Props) {
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Edit {role.name}'s information</p>
                                </div>
                            </div>
                        </div>
                    </div>
